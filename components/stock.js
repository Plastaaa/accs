...
export default class Stock extends React.Component {
  ...
  componentDidMount() {
        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getAllMarque.php?concesss=11`)
        .then(res => {
          const brands = res.data;
          this.setState({ brands });
        });

        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getAllCCDstctGamme.php?concesss=11`)
        .then(res => {
          const gammes = res.data;
          this.setState({ gammes });
        });

        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getAllCCDstctEtat.php?concesss=11`)
        .then(res => {
          const etats = res.data;
          this.setState({ etats });
        });

        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getAllCCDstctPorteur.php?concesss=11`)
        .then(res => {
          const porteurs = res.data;
          this.setState({ porteurs });
        });

        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getConcess.php?concesss=11`)
        .then(res => {
