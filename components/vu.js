    ...
    componentDidMount() {
        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getCCDetailById.php?id=${window.location.pathname.split('/')[2]}`)
          .then(res => {
            ...
            axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getVideoByCCName.php?nom=${cc.marque+" "+cc.modele+" "+cc.version}`)
                .then(res2 => {
        ...
        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getAllVisualsByCC.php?id=${window.location.pathname.split('/')[2]}&concess=11`)
          .then(res => {
            const imgCC = res.data;
            this.setState({ imgCC });
        })
        
        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/getAllEquipByCC.php?id=${window.location.pathname.split('/')[2]}&concess=11`)
          .then(res => {
            const equips = res.data;
            this.setState({ equips });
        })

        axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/get2CCSimi.php?id=${window.location.pathname.split('/')[2]}&concess=11`)
          .then(res => {
    ...
    render() {
        ...
        return (
            ...
            this.state.campingcar.map((cc) => (
                ...
                <div>
                    <Helmet>
                        <title>Auto Camping car Service - {cc.marque + " " + cc.modele + " " + cc.version}</title>
                    </Helmet>
