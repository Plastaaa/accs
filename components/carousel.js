...
export default class SimpleSlider extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/SLIDE/getSlideMobile.php?site=11`)
    .then(res => {
      const slideM = res.data;
      this.setState({ slideM });
    });

    axios.get(`https://nunesaccount.alwaysdata.net/APIDG8/SLIDE/getSlide.php?site=11`)
    .then(res => {
